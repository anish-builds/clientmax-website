...
// Recognizable, minimal SVG icons
  ...
  return (
    <footer className="relative bg-gray-950 border-t border-gray-900 text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
        ...
        {/* ========================================================= */}
        <div className="pt-20 sm:pt-28 pb-16 sm:pb-20 max-w-3xl space-y-7">
        ...
        {/* ========================================================= */}
        {/* 2. FREQUENTLY ASKED QUESTIONS (SEAMLESSLY INTEGRATED)     */}
        {/* ========================================================= */}
        <div className="border-t border-gray-900 pt-16 sm:pt-20 pb-16 sm:pb-20">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between pb-12 sm:pb-14 border-b border-gray-900 gap-6">
          ...
          {/* Accordion List */}
          <div className="divide-y divide-gray-900 border-b border-gray-900">
            {FAQS.map((item, idx) => {
              ...
              return (
                <div key={item.id} className="transition-colors">
                  <button
                    ...
                    className="w-full py-6 px-2 sm:px-4 flex items-center justify-between gap-6 text-left cursor-pointer group hover:bg-gray-900/30 transition-colors"
                  >
                    <div className="flex items-baseline gap-4 sm:gap-6 pr-4">
                      ...
                      <h4
                        className={`text-base sm:text-lg font-bold font-display transition-colors ${
                          isOpen ? 'text-green-400' : 'text-gray-200 group-hover:text-white'
                        }`}
                      >
                        {item.question}
                      </h4>
                    ...
                    <div
                      className={`p-1.5 rounded-full border transition-colors shrink-0 ${
                        isOpen
                          ...
                          : 'border-gray-800 text-gray-500 bg-gray-900 group-hover:border-gray-700 group-hover:text-gray-300'
                      }`}
                    >
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <div className="pb-7 pt-1 px-2 sm:px-4 pl-8 sm:pl-12 max-w-4xl">
        ...
        <div className="border-t border-gray-900 pt-16 pb-14">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-14">
            ...
            <div className="md:col-span-3 space-y-4">
              <span className="text-xs font-mono tracking-widest text-gray-400 uppercase block font-semibold">
                NAVIGATION
              </span>
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {SOCIAL_LINKS.map((social) => (
                  <a
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-gray-900 border border-gray-800 hover:border-green-600 hover:text-green-400 rounded-sm text-gray-300 transition-colors group"
                  >
        ...
        {/* 4. LEGAL DISCLOSURE                                       */}
        {/* ========================================================= */}
        <div className="py-7 border-t border-gray-900 text-xs text-gray-400 leading-relaxed font-light">
          <p className="max-w-5xl">
            <strong className="text-gray-300 font-semibold uppercase tracking-wider font-mono mr-2">DISCLOSURE:</strong>
        ...
        {/* 5. BOTTOM BAR                                             */}
        {/* ========================================================= */}
        <div className="flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 pt-7 pb-8 border-t border-gray-900 gap-4 font-mono">
